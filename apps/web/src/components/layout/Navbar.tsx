...
const navLinks = [
  { href: "/dashboard#project", label: "Projects" },
  { href: "/dashboard#mrv", label: "MRV" },
  { href: "/dashboard#verify", label: "Verify" },
  { href: "/dashboard#issue", label: "Issue" },
  { href: "/dashboard#market", label: "Market" },
  { href: "/dashboard#retirement", label: "Retire" },
...
export function Navbar() {
  ...
  const headerBg = useTransform(
    scrollY,
    [0, 80],
    ["rgba(5, 8, 16, 0.95)", "rgba(5, 8, 16, 1)"],
  );
  ...
  return (
    <>
      <a
        href="#main-content"
        className="fixed -top-full left-4 z-[100] px-4 py-2 bg-[#047857] text-white rounded-lg text-sm font-medium transition-all focus:top-4"
      >
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            <div
              className="absolute inset-0 bg-[#050810]/98 backdrop-blur-2xl"
              role="button"
              tabIndex={0}
