...
ARG NEXT_PUBLIC_TERRAQURA_DEPLOYMENT_PROFILE
...
ENV NEXT_PUBLIC_TERRAQURA_DEPLOYMENT_PROFILE=$NEXT_PUBLIC_TERRAQURA_DEPLOYMENT_PROFILE
...
ENV NEXT_PUBLIC_ALLOW_INSECURE_TESTNET_RPC=$NEXT_PUBLIC_ALLOW_INSECURE_TESTNET_RPC
ENV NEXT_PUBLIC_AETHELRED_NETWORK_ANCHOR_BLOCK=$NEXT_PUBLIC_AETHELRED_NETWORK_ANCHOR_BLOCK
ENV NEXT_PUBLIC_AETHELRED_NETWORK_ANCHOR_HASH=$NEXT_PUBLIC_AETHELRED_NETWORK_ANCHOR_HASH
