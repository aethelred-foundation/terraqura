...
ARG NEXT_PUBLIC_MULTISIG_ADDRESS
ARG NEXT_PUBLIC_TIMELOCK_ADDRESS
ARG NEXT_PUBLIC_GASLESS_MARKETPLACE_ADDRESS
...
ENV NEXT_PUBLIC_MULTISIG_ADDRESS=$NEXT_PUBLIC_MULTISIG_ADDRESS
ENV NEXT_PUBLIC_TIMELOCK_ADDRESS=$NEXT_PUBLIC_TIMELOCK_ADDRESS
ENV NEXT_PUBLIC_GASLESS_MARKETPLACE_ADDRESS=$NEXT_PUBLIC_GASLESS_MARKETPLACE_ADDRESS
